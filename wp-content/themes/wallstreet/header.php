...
<head>
	...
	<?php wp_head(); ?>	
        <style>
        .sina img{width: 24px;height: 24px}
        .eos img{width: 22px;height: 22px}            
        </style>
</head>
<body <?php body_class(); ?>>
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ul class="head-contact-social">
					...
					<?php }
					if($current_options['social_media_sina_link']!='') { ?>
                                        <li><a href="<?php echo esc_url( $current_options['social_media_sina_link'] ); ?>"><i class="sina"><img src="/wp-content/themes/wallstreet/images/WB_logo.png" /></i></a></li>	
					<?php }
					if($current_options['social_media_eos_link']!='') { ?>
					<li><a href="<?php echo esc_url( $current_options['social_media_eos_link'] ); ?>"><i class="eos"><img src="/wp-content/themes/wallstreet/images/eos.png" /></i></a></li>                                        
                                        <?php } ?>
