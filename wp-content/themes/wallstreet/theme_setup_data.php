...
function theme_data_setup()
{
	...
	return $theme_options=array(
			...
			'service_description_three' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
                        ...
                        'service_image_four' => $service_image3, 
			'service_title_four'=> '测试',
			'service_description_four' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
                        ...
                        'service_image_five' => $service_image3, 
			'service_title_five'=> __('Responsive designs','wallstreet'),
			'service_description_five' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
			
                        'service_image_six' => $service_image3, 
			'service_title_six'=> __('Responsive designs','wallstreet'),
			'service_description_six' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
			
                        'service_image_seven' => $service_image3, 
			'service_title_seven'=> __('Responsive designs','wallstreet'),
			'service_description_seven' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
            			
                        'service_image_eight' => $service_image3, 
			'service_title_eight'=> __('Responsive designs','wallstreet'),
			'service_description_eight' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
            			
                        'service_image_nine' => $service_image3, 
			'service_title_nine'=> __('Responsive designs','wallstreet'),
			'service_description_nine' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.Lorem ipsum dolor sit amet, consectetur adipisicing elit dignissim dapib tumst dign eger porta nisl.',
			...
			'home_blog_description' => __('We work with new customers and grow their business.','wallstreet'),
                        ...
                        //Home text
                        'txt_section_enabled' => true,
                        'home_txt_heading'=> '',
                        'home_txt_description' => '',
			...
			'social_media_youtube_link' =>"",
                        'social_media_sina_link' =>"https://weibo.com/xxcgj",
                        'social_media_eos_link' =>"http://t.me/EOS90s",
